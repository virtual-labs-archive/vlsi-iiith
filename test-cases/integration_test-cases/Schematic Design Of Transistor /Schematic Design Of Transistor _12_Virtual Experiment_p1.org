...
* Test Steps
  ...
  8. Select Psedo NMO'S logic from the dropdown displayed on the screen
...
* Expected result
  ...
  5. The selected logic should be displayed on the screen and when we click on the simulator button, the simulation output Graphs should be displayed on the screen
