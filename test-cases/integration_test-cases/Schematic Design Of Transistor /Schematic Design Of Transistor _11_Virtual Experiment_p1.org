...
* Objective
  - To perform the Virtual Experiment of the Schematic Design Of Transistor Level Inverter experiment
...
* Test Steps
  ...
  8. Select Complementary CMO'S logic from the dropdown displayed on the screen
...
* Expected result
  ...
  5. The selected logic should be displayed on the screen and when we click on the simulator button, the simulation output should be displayed on the screen
