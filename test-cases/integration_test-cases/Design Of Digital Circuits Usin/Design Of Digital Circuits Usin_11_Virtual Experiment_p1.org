...
* Test Steps
  ...
  6. Insert the code in OR Gate Verilog and OR Gate Testbench boxes and click on simulation button
  7. After displaying the output result click on the download output file button
...
* Expected result
  ...
  5. The simulation output result should be displayed on the screen and when we click on the download button the  simulation should start downloading
