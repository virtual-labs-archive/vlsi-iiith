...
public class exp6_flipflop_negative extends JApplet 
{
	public  void init()
	{
	...
	public  class MyPanel extends JPanel  implements ActionListener , MouseMotionListener 
	{
		...
		int exp_type = 0 ; // 0 -> FlipFlop / 1-> Latch
...
//				g.drawRect( x , y , 2*width , 2*width);
		...
		{
			String fileToRead = "outfile_flipflop_n";
...
//Setting Top Panel ========================================================================== 
			...
			JLabel heading = new JLabel (  "<html><FONT COLOR=WHITE SIZE=18 ><B> D-Flip Flop : Negative Edge Trigger </B></FONT></html>", JLabel.CENTER);
			...
			String[] my_list = { "D Flip-Flop : Negativetive Edge " };
...
*/			// Used Replaced array only for indexies ( 0-23 ) i.e NPOS and PMOS
			...
			if ( exp_type == 0 ) // Flip Flop
			{
				...
				{
					if ( check_points_value[8][l] != 8 &&    check_points_value[8][l] != 3 )
					{
				...
				{
					if ( check_points_value[9][l] != 9 &&  check_points_value[9][l] != 0 )
					{
							System.out.println("clk'");			
						return false ;
					}
