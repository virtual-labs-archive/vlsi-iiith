...
public class exp5_Pass extends JApplet 
{
	public  void init()
	{
...
//				g.drawRect( x , y , 2*width , 2*width);
		...
		{
			String fileToRead = "outfile_pass";
		...
		//public  graph()
			...
			public void make_graph()
			{
				if ( exp_type == 0 )
				{
					fileToRead ="outfile_pass";
				}
				else if ( exp_type == 1 )
				{
						fileToRead ="outfile_multiplexer";
				}
				URL url = null;
				try
				{
...
//Setting Top Panel ========================================================================== 
			...
			JLabel heading = new JLabel (  "<html><FONT COLOR=WHITE SIZE=18 ><B> PASS TRANSISTOR </B></FONT></html>", JLabel.CENTER);
			...
			String[] my_list = {"Pass Transistor Circuit " , "2-Input Multiplexer Circuit"};
...
*/			// Used Replaced array only for indexies ( 0-23 ) i.e NPOS and PMOS
			...
			if ( exp_type == 0 ) // for Pass Transistor  
			{
				...
				{
					if ( check_points_value[2][l] != 2 && check_points_value[2][l] != 8 )
					{
						return false ;
					}
					l++;
				...
				{
					if ( check_points_value[5][l] != 5 &&  check_points_value[5][l] != 7 )
					{
						return false ;
					}
					l++;
			...
			if ( e.getSource() == exp_list )
			{
				...
				// Move to the Mux exp =========================================
					...
					try
					{
						...
						URL url = new URL(base ,"exp5_mux.html");
			...
			*/
				if ( Pmos1_l != null && Pmos1_w != null && Nmos1_l != null && Nmos1_w != null && circuit_check())
				{
					...
					try
					{
						if ( exp_type == 0 )
						{
							php_file = new URL(getDocumentBase(),"exp5_Pass_simulate.php");
							System.out.println( php_file.toString());
						}
						else if ( exp_type == 1 )
						{
							php_file = new URL(getDocumentBase(),"exp5_Multiplexer_simulate.php");
							System.out.println( php_file.toString());
						}
					}
					catch(Exception mye )
