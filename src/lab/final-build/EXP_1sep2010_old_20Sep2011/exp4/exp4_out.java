	...
	public  class MyPanel extends JPanel  implements ActionListener 
	{
		...
		public class drawPanel extends JPanel 
		{
			...
			public void paint(Graphics g)
			{
				...
				{
					g2d.drawLine(20+2*i , 120-(int)Math.round(Double.parseDouble(out[output_selected][i])*100) , 20 + (i+1)*2 , 120-(int)Math.round(Double.parseDouble(out[output_selected][i+1])*100) );
				}

				g2d.setStroke(new BasicStroke(2));
				g2d.setColor(Color.black);
				g2d.drawLine(20 , 420 ,20  ,  0 );
				g2d.drawLine(0 , 122 , 500  , 122 );


				g2d.setFont( new Font("Arial" , Font.BOLD , 14));
//				g2d.drawString("WAVEFORM OF THE SELECTED OUTPUT", 10 , 20 );

				g2d.drawString("Time --> ",  150 , 140 );

				g2d.rotate(-3.14/2 , 16 , 100 );
				g2d.drawString(output.getSelectedItem().toString(), 16 , 100 );
				g2d.rotate(3.14/2 , 16 , 100 );
