...
fwrite($f , "M1 out b N Vdd PMOS l=$comp_value[0] w=$comp_value[1]\n");
fwrite($f , "M2 N a vdd vdd PMOS l=$comp_value[4] w=$comp_value[5]\n");
fwrite($f , "M3 0 a out 0 NMOS l=$comp_value[2] w=$comp_value[3]\n");
fwrite($f , "M4 0 b out 0 NMOS l=$comp_value[6] w=$comp_value[7]\n");
...
`ngspice -b  inv22_nor.sp -r rawfile_nor`;
`cat rawfile_nor |tr [:blank:] "\n" >  outfile_nor`;
`rm rawfile_nor`;
