...
public class exp1 extends JApplet 
{
	...
	public  class MyPanel extends JPanel  implements ActionListener , MouseMotionListener 
	{
		...
		ImageIcon icon_unmove ;
		ImageIcon icon_unstretch ;
		ImageIcon icon_uncopy ;
...
//					System.out.println("node index is "+node_index);
		...
		{
			int width1[]={10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10};
			int width2[]={10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10,10};
			int pos_x[]={0,0};
			int pos_y[]={0,0};
			int c_x = 0;
			int c_y = 0;
...
//					wire[total_wire-1 ].update2((work_x/20)*20 , (work_y/20)*20);
			...
			public void mouseClicked(MouseEvent me) 
			{
				...
				if(checkstate == 1)
				{
					...
					//System.out.println("w1 "+work_mat[work_x][work_y]+" w2 "+work_mat2[work_x][work_y]);
					layer1 = work_mat[work_x][work_y];
					layer2 = work_mat2[work_x][work_y];
					//System.out.println("distance is "+(comp_node[layer1].node_x - comp_node[layer2].node_x));
					
					System.out.println("index "+work_mat[work_x][work_y]);
					System.out.println("work is "+work_x+"y "+work_y);
					String s_active = "";
					String s = "" ;
					String s_1 = "";
					String s_2 = "";
					...
					{
						JFrame frame = new JFrame("Circuit Check");
						JTextField text = null;
						if(comp_node[layer1].img_no == 8)
						{
							int xl = comp_node[layer1].node_x;
							if(comp_node[layer1].width < 30 && comp_node[layer1].height < 30 )
								s_8 = "Metal component size is incorrect : "+comp_node[layer1].width;
							s = s + s_8;
							int adjacent_node ;
							adjacent_node = work_mat[xl - 10][work_y];
							//System.out.println("a node "+adjacent_node);
							for(int position = xl ; position > xl - 20 ; position--)
							{
								adjacent_node = work_mat[position - 10][work_y];
								System.out.println("adj node "+adjacent_node);
							if(work_mat[position - 10][work_y] != -1)
							{
								System.out.println("img "+comp_node[adjacent_node].img_no);
								adjacent_node = work_mat[position - 10][work_y];
								if(comp_node[adjacent_node].img_no == 2)
							        {
									s_2 = s_2 + " Distance between actives is incorrect\n";				
									break;
								}
							}
							if(work_mat[position - 20][work_y] != -1)
							{
								adjacent_node = work_mat[position - 20][work_y];
								System.out.println("img "+comp_node[adjacent_node].img_no);
								System.out.println("a node "+adjacent_node);
								if(comp_node[adjacent_node].img_no == 2 && s_active == null)
								{
									s_2 = s_2 + " Distance between actives is incorrect\n";
									break;
								}
						...
						if(comp_node[layer1].img_no == 1)
						{
							int xl = comp_node[layer1].node_x;
							if(comp_node[layer1].width < 30 && comp_node[layer1].height < 30)
								s_1 = "Active component size is incorrect : "+comp_node[layer1].width;
							System.out.println("its pos is "+xl);
							int adjacent_node ;
							adjacent_node = work_mat[xl - 10][work_y];
							System.out.println("a node "+adjacent_node);
							for(int position = xl ; position > xl - 20 ; position--)
							{
							if(work_mat[position][work_y] != -1)
							{
								adjacent_node = work_mat[position][work_y];
								System.out.println("a node "+adjacent_node);
								if(comp_node[adjacent_node].img_no == 1)
							 	{
									s_1 = s_1 + " Distance between actives is incorrect\n";
									s = s+s_1;
									break;
								}
							}
							if(work_mat[position - 10][work_y] != -1)
							{
								adjacent_node = work_mat[position - 10][work_y];
								System.out.println("a node "+adjacent_node);
								if(comp_node[adjacent_node].img_no == 1 && s_active == null)
								{
									s_1 = s_1 + " Distance between actives is incorrect\n";
									s = s + s_1;
									break;
					...
					if(comp_node[layer1].img_no == 4)
					{
							int xl = comp_node[layer1].node_x;
							if(comp_node[layer1].width < 100 && comp_node[layer1].height < 100)
								s_4 = "Metal component size is incorrect : "+comp_node[layer1].width;
							s = s + s_4;
							System.out.println("its pos is "+xl);
							int adjacent_node ;
							adjacent_node = work_mat[xl - 10][work_y];
					...
					if(comp_node[layer1].img_no == 2)
						{
							int xl = comp_node[layer1].node_x;
							s_active = "";
							if(comp_node[layer1].width < 30)
								s_2 = "Metal component size is incorrect : "+comp_node[layer1].width;
							int adjacent_node ;
							adjacent_node = work_mat[xl - 10][work_y];
							//System.out.println("a node "+adjacent_node);
							for(int position = xl ; position > xl - 20 ; position--)
							...
							if(work_mat[position - 10][work_y] != -1)
							{
								...
								if(comp_node[adjacent_node].img_no == 2)
							        {
									s_2 = s_2 + " Distance between metals is incorrect\n";
									break;
								}
							}
							if(work_mat[position - 20][work_y] != -1)
						...
						if(comp_node[layer1].img_no == 10)
						{
							int xl = comp_node[layer1].node_x;
							s_active = "";
							if(comp_node[layer1].width < 30)
								s_10 = "Metal component size is incorrect : "+comp_node[layer1].width;
							int adjacent_node ;
							adjacent_node = work_mat[xl - 10][work_y];
							//System.out.println("a node "+adjacent_node);
							for(int position = xl ; position > xl - 20 ; position--)
						...
						if(comp_node[layer1].img_no == 3)
						{
							int xl = comp_node[layer1].node_x;
							s_active = "";
							if(comp_node[layer1].width < 30)
								s = "Metal component size is incorrect : "+comp_node[layer1].width;
							int adjacent_node ;
							adjacent_node = work_mat[xl - 10][work_y];
							//System.out.println("a node "+adjacent_node);
							for(int position = xl ; position > xl - 20 ; position--)
						...
						if(comp_node[layer1].img_no == 7)
						{
							int xl = comp_node[layer1].node_x;
							s_active = "";
							if(comp_node[layer1].width < 30)
								s_7 = "Metal component size is incorrect : "+comp_node[layer1].width;
							int adjacent_node ;
							adjacent_node = work_mat[xl - 10][work_y];
							s = s + s_7;
							//System.out.println("a node "+adjacent_node);
					...
					if(work_mat[work_x][work_y] != -1 && work_mat2[work_x][work_y] != -1)
					{
						distance = (comp_node[layer1].node_x - comp_node[layer2].node_x);
						if(distance < 0)
							distance = -distance;
						JFrame frame = new JFrame("Circuit Check");
						JTextField text = null;
						s = Integer.toString(distance);
						String s1 = "The distance is ";
						String s2 = "The distance should be 20";
						System.out.println("l1 is "+layer1+" l2 is "+layer2);
						System.out.println("img_no "+(comp_node[layer1].img_no));
						
						if(comp_node[layer1].img_no == 1 && comp_node[layer2].img_no == 3 && distance != 20)
						{
					
							if(comp_node[layer1].width > 30)
								s = s1+s+" "+s2+" Active component width is correct ";
							else 
								s = s1+s+" "+s2+" Active component width is incorrect ";
							System.out.println("node_drag "+node_drag);
							if(comp_node[layer2].width > 20)
								s = s+"\n"+" Polycontact size is correct";
							else 
								s = s+"\n"+" Polycontact size is incorrect";
							text = new JTextField(s,180);
							// Add a window listner for close button
							frame.addWindowListener(new WindowAdapter() {
						...
						if(comp_node[layer1].img_no == 1 && comp_node[layer2].img_no == 3 && distance == 20)
						{
							String message = "Distance is correct";
							if(comp_node[layer1].width > 30)
								message = message+" Active component width is correct ";
							else 
								message = message+" Active component width is incorrect ";
							System.out.println("hello");
							if(comp_node[layer2].width > 20)
								message = message+"\n"+" Polycontact size is correct";
							else 
								message = message+"\n"+" Polycontact size is incorrect";
							text = new JTextField(message,180);
							// Add a window listner for close button
							frame.addWindowListener(new WindowAdapter() {
						...
						/*if(layer1 == 0)
						{
								String message1 = "width is correct";
								String message2 = "width is less than 30";
							
							if(comp_node[layer1].width > 30)
								text = new JTextField(message1,80);
							else
								text = new JTextField(message2,80);
							System.out.println("node_drag "+node_drag);
							// Add a window listner for close button
							frame.addWindowListener(new WindowAdapter() {
...
//		JPanel contentPane = new JPanel(new BorderLayout());
		JPanel topPanel = new JPanel () ;
			...
			JButton unstretch_button ;
			JButton unmove_button ;
			JButton uncopy_button ;
 ...
 */			
			...
			JLabel heading1 = new JLabel (  "<html><FONT COLOR=WHITE SIZE=6 ><B>EDIT OPTIONS</B></FONT></html>", JLabel.CENTER);
			heading1.setBorder(BorderFactory.createRaisedBevelBorder( ));
		//	heading1.setBorder(BorderFactory.createEtchedBorder( Color.black , Color.white));
			...
			if (imgURL4 != null) 
			{
				...
				icon_uncopy     =  new ImageIcon(imgURL4);
				icon_unmove     =  new ImageIcon(imgURL4);
				icon_unstretch  =  new ImageIcon(imgURL4);
				icon_movey2     =  new ImageIcon(imgURL4);
				icon_copy       =  new ImageIcon(imgURL4);
				icon_check      =  new ImageIcon(imgURL4);
			...
			check_button = new JButton("   CHECK  " , icon_check );
			...
			uncopy_button = new JButton (" UNCOPY " , icon_uncopy);
			icon_uncopy.setImageObserver(uncopy_button);
			
			paste_button = new JButton ("   SCALE  " , icon_paste);
			icon_paste.setImageObserver(paste_button);

			unmove_button = new JButton (" UNMOVE " , icon_unmove);
			icon_unmove.setImageObserver(unmove_button);
			
			movey1_button = new JButton("STRETCH" , icon_movey1 );
			icon_movey1.setImageObserver(movey1_button);

			unstretch_button = new JButton("UNSTRETCH " , icon_unstretch );
			icon_unstretch.setImageObserver(unstretch_button);
...
//			headButton1.add(movex2_button );
		//	headButton1.add(movey2_button );
			...
			headButton1.add(check_button );
			//by shashank ----			headButton1.add(unmove_button );
			//by shashank -----------------------// headButton1.add(unstretch_button );
			//by shashank------			headButton1.add(uncopy_button );
//			headButton1.add(mag_button );

			movex1_button.addActionListener(this);
			unmove_button.addActionListener(this);
//			movex2_button.addActionListener(this);
			...
			uncopy_button.addActionListener(this);
			unstretch_button.addActionListener(this);
...
//---------------------------------------------------------------------------------
// Setting Main  Panel---------------------------------------------- 
			splitPane = new JSplitPane( JSplitPane.HORIZONTAL_SPLIT , leftPanel , workPanel);
			splitPane.setOneTouchExpandable(true); // this for one touch option 
			splitPane.setDividerLocation(0.1);  
			add(splitPane, BorderLayout.CENTER);
//------------------------------------------------------------------------------------
// Setting LEFT Panel of Main  ============================================================
			leftPanel.setLayout(new BorderLayout());
			leftPanel.setMinimumSize(new Dimension(350 , 600)); // for fixing size

			leftSplitPane = new JSplitPane( JSplitPane.HORIZONTAL_SPLIT , toolPanel , rightPanel); // spliting left in tool & right(button panel) 
...
//			bottom.add(h );
		...
		public void delete_node (int no)
		{
		...
		public void scalefunc()
		{
			...
			JTextField text = null;
			String s1 = Integer.toString(comp_node[node_drag].width/10);
			String s2 = Integer.toString(comp_node[node_drag].height/10);
			String s ="x is "+s1+" y is "+s2;
			System.out.println("s is "+s);
			System.out.println("node_drag "+node_drag);
			text = new JTextField(s,30);
		// Add a window listner for close button
		frame.addWindowListener(new WindowAdapter() {
...
/*			public void windowClosing(WindowEvent e) {
		...
		public void actionPerformed(ActionEvent e )
		{
			...
			if(e.getSource() == unstretch_button )
			{
				stretching = 0;
				System.out.println("Unstrech:(\n");
			}
			if(e.getSource() == check_button )
			{
				checkstate = 1;
			}
			if(e.getSource() == uncopy_button )
			{
				copystate = 0;
			}
			if(e.getSource() == unmove_button )
			{
				movestate = 0;
			}
