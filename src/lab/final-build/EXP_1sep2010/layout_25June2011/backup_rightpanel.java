...
//					wire[total_wire-1 ].update2((work_x/20)*20 , (work_y/20)*20);
			...
			public void mouseDragged(MouseEvent me)
			{
				...
				obj.delComp();
				System.out.println("node drag "+node_drag);
				...
				{
					//if(temp_x <= me.getX() < (temp_x+10))	//and work_y <= temp_y
					//{
						width2[0] = ((int)((-temp_y + work_y)/10) + 1)*10 + width2[0];
						comp_node[node_drag].node_y = comp_node[node_drag].node_y +((int)((+temp_y - work_y)/10) + 1)*10;
						if(width2[0] < 0)
							width2[0] = -width2[0];
						width1[0] = 10;
						System.out.println("Component y is "+comp_node[node_drag].node_y);
						System.out.println("width2 is "+width2[0]+"width1 is "+width1[0]);
					//}
					/*if( temp_x+10 < me.getX() <= temp_x+12 )
					{
...
content.add(new JButton("four"));*/
			...
			option_button[3] = new JButton(" Position " , icon_simulate );
