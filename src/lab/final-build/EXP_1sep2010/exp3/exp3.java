...
//                         -------------------------			need to wrtie this part of code
	...
	//--------------------------------------------------------------------------------
			...
			if ( exp_type == 0 ) // for XOR 
			{
				...
				{
					if ( check_points_value[replace[5]][l] != replace[5] && check_points_value[replace[5]][l] != 25 && check_points_value[replace[5]][l] != replace[20])
					{
						return false ;
					}
					l++;
				...
				{
					if ( check_points_value[26][l] != replace[8] && check_points_value[26][l] != 26 && check_points_value[26][l] != replace[17])
					{
						return false ;
					}
					l++;
				...
				{
					if ( check_points_value[30][l] != 30 && check_points_value[30][l] != replace[12] && check_points_value[30][l] != replace[15] )
					{
						return false ;
					}
					l++;
				...
				{
					if ( check_points_value[28][l] != 28 && check_points_value[28][l] != 31 && check_points_value[28][l] != 32 && check_points_value[28][l] != replace[3] && check_points_value[28][l] != replace[22] && check_points_value[28][l] != replace[19] && check_points_value[28][l] != 0 )
					{
						return false ;
					}
					l++;
				...
				{
					if ( check_points_value[replace[13]][l] != replace[13] && check_points_value[replace[13]][l] != replace[16] && check_points_value[replace[13]][l] != replace[21] && check_points_value[replace[13]][l] != replace[18] )
					{
						return false ;
					}
					l++;
...
//--------------------------------------------------------------------------------------------------------------------------------
			else if ( exp_type == 1 ) // XNOR 
			{
				...
				while (  check_points_value[26][l] != -1 )
				{
					if ( check_points_value[26][l] != 26 &&  check_points_value[26][l] != replace[11]  &&  check_points_value[26][l] != 23  )
					{
						return false ;
					}
					l++;
				...
				while (  check_points_value[27][l] != -1 )
				{
					if ( check_points_value[27][l] != replace[8] && check_points_value[27][l] != 27 && check_points_value[27][l] != replace[17])
					{
						return false ;
					}
					l++;
