...
mysql_select_db($db);
$result = mysql_query("UPDATE content SET title = '".$ptitle."',author = '".$author."' , posttext = '".$content."', date = '".$today."' WHERE pid ='".$pid."' AND tid ='".$tabid."'") or die("MySQL Login Error: ".mysql_error()); 
