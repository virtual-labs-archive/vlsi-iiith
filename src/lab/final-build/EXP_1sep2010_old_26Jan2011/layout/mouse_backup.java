...
*/
			...
			public void paint(Graphics g) 
			{
				...
				//g2d.drawString(s, 100, 20);

			//	draw_active(g2d , 40 , 40 , 20);
			//	draw_poly(g2d , 200 , 200 , 20);
				...
				for ( i = 0; i < total_comp ; i++ )
				{
					if ( comp_node[i].del != true )
					{
						if ( comp_node[i].img_no == 3)
						{
							...
							//g.drawString(comp_str[3] , comp_node[i].node_x -10 , comp_node[i].node_y + 10 );
						}
						else if ( comp_node[i].img_no == 1)
						{
							draw_active(g2d , comp_node[i].node_x  , comp_node[i].node_y , 20 , comp_node[i].angle);
							g.setColor(Color.yellow);
...
/*				g.setStroke(new BasicStroke(2));
			...
			void draw_active(Graphics2D g , int x , int y , int width , double angle )
			{
				Stroke drawingStroke = new BasicStroke(3, BasicStroke.CAP_BUTT, BasicStroke.JOIN_BEVEL, 0, new float[]{9}, 0);
				Line2D line = new Line2D.Double(20, 40, 100, 40);		
				g.rotate(angle , x , y);
 ...
 */			
			...
			JPanel headButton1 = new JPanel (new FlowLayout(FlowLayout.CENTER )) ;
			JPanel headButton2 = new JPanel (new FlowLayout(FlowLayout.CENTER )) ;
			JPanel headButton3 = new JPanel (new FlowLayout(FlowLayout.CENTER )) ;
...
content.add(new JButton("four"));*/
			...
			rightPanel.add(headButton2 , BorderLayout.CENTER);
			rightPanel.add(headButton3 , BorderLayout.CENTER);
			...
			option_button[2] = new JButton(" Copy " , icon_simulate );
			option_button[3] = new JButton(" Delete " , icon_simulate );
			System.out.println("("+MouseInfo.getPointerInfo().getLocation().x+", "+MouseInfo.getPointerInfo().getLocation().y+")");

			
			//JLabel position = new JLabel (  "<html><FONT COLOR=WHITE SIZE=10 ><B> "mouse_x"</B></FONT></html>", JLabel.CENTER);
			
			icon_simulate.setImageObserver(option_button[1]);
			icon_simulate.setImageObserver(option_button[2]);
			icon_simulate.setImageObserver(option_button[3]);
			option_button[1].setToolTipText("For Simulation");

			headButton1.add(option_button[1]);
			headButton2.add(option_button[2]);
			headButton3.add(option_button[3]);


			option_button[1].addActionListener(this);
			option_button[2].addActionListener(this);
			option_button[3].addActionListener(this);
...
//			rightPanel.add(wave_head, BorderLayout.NORTH);
			rightPanel.add(option_button[1],BorderLayout.CENTER);
			option_button[1].setVerticalAlignment(SwingConstants.BOTTOM);
			rightPanel.add(option_button[2],BorderLayout.CENTER);
			option_button[2].setVerticalAlignment(SwingConstants.BOTTOM);
			rightPanel.add(option_button[3],BorderLayout.CENTER);
			option_button[3].setVerticalAlignment(SwingConstants.BOTTOM);*/
...
//			bottom.add(h );
		...
		public void actionPerformed(ActionEvent e )
		{
			...
			{
					System.out.println("Delete pressed yaay!");
					//call.del_comp();
				//	System.out.println(node_index);
			}
