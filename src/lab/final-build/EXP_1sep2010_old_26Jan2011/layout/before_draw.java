...
//					wire[total_wire-1 ].update2((work_x/20)*20 , (work_y/20)*20);
			...
			public void mouseDragged(MouseEvent me)
			{
				...
				WorkPanel object = new WorkPanel();
				object.draw_active();
	
				if(node_drag == 1)
					draw_active(g2d , work_x ,work_y,20 , comp_node[node_drag].angle);
				// Moving	
				/*if ( wire_drag != -1 )
				{
			...
			public void mouseClicked(MouseEvent me) 
			{
				...
				work_x = me.getX();
				work_y = me.getY();
				System.out.println("yaaaaay!!! Mouse clicked");
				System.out.println(" x is "+work_x+"y is "+work_y);
...
//			bottom.add(h );
		...
		public void actionPerformed(ActionEvent e )
		{
			...
			{
				System.out.println("Co-ordinates pressed yaay!");
