...
Activate the editing tools Once on the page. Go to start, run & write %APPDATA%\Mozilla\Firefox\Profiles\ in the tab. Press enter. double click on the folder which has (default) included in its name. Search for a user.js file. if not available, then create it. 
Edit the file & enter the following details.

user_pref("capability.policy.policynames", "allowclipboard");
user_pref("capability.policy.allowclipboard.sites", "http://your website address");
user_pref("capability.policy.allowclipboard.Clipboard.cutcopy", "allAccess");
user_pref("capability.policy.allowclipboard.Clipboard.paste", "allAccess");

edit & save the file. Restart Mozilla or firefox. and editing tools are activated now. Its preferable to write something first & then start using the tools.
...
Using the Top Menu:-
There is a file named blank.php supplied with other. whenever a new top menu tab is added, the caption is also given a link under it. This link has a xxx.php file under it where 
