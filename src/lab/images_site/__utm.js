...
function SuburchinTracker(page)
{
 _udt=new Date();
...
function Sub2urchinTracker(page)
 {
 var a,b,c,v,x="",s="",f=0;
 ...
 SuburchinTracker(page);
 }
function urchinTracker(page) {
 if (_udl.protocol=="file:") return;
 if (_uff && (!page || page=="")) return;
  checkSub2urchinTracker(page);
 }
 s=_udl.search;
