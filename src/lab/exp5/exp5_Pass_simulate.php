...
//---------------------------------------------------
fwrite($f , "*Pass Transistor \n");
fwrite($f , ".include '45nm_HP.pm'\n");

fwrite($f , "M1 In clk1 out Vdd PMOS l=$comp_value[0] w=$comp_value[1]\n");
fwrite($f , "M2 In clk out 0 NMOS l=$comp_value[2] w=$comp_value[3]\n");
...
`ngspice -b  inv5_pass.sp -r rawfile_pass`;
`cat rawfile_pass |tr [:blank:] "\n" >  outfile_pass`;
`rm rawfile_pass`;
